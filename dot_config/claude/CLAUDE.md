...
- When investigating third-party projects/repos, `git clone` them to `~/third-party-code/` instead of using WebFetch on GitHub URLs. This gives full access to browse the code with Read/Grep/Glob.
